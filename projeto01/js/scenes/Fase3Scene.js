...
// REMOVA todas estas declarações globais
// let player;
// let platforms;
// let cursors;
// let stars;
...
class Fase3Scene extends Phaser.Scene {
    ...
    create() {
        ...
        // Use `this.` para criar as propriedades da cena
        this.platforms = this.physics.add.staticGroup();
        this.platforms.create(400, 568, 'ground').setScale(2).refreshBody();
        this.platforms.create(600, 400, 'ground');
        this.platforms.create(100, 450, 'ground');
        this.platforms.create(500, 250, 'ground');
        this.platforms.create(750, 150, 'ground');
        this.platforms.create(250, 200, 'ground');

        // Use `this.` para criar o jogador
        ...
        // Use `this.` para os controles
        this.cursors = this.input.keyboard.createCursorKeys();

        // Use `this.` para os grupos de itens
        ...
        // Use `this.` para o texto da pontuação
